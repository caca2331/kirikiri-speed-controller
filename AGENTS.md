...
runtime-notes.md records key observations/ideas discovered within tasks.
...
- Don't ask for approval for making changes within the workspace, you have the approval.
...
- After finish a task, summarize in a few sentences, append to agentlog.md.
